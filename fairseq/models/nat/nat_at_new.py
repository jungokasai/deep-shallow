...
class NATATDecoder(TransformerDecoder):
    ...
    def forward(
        ...
        **unused
        ...
        if not inference:
            ...
            #bottom_features = bottom_features[:, :prev_output_tokens.size(1)]
    ...
    def cmlm_mask(self, prev_output_tokens_nat, encoder_out, full_mask):
        ...
        prev_output_tokens_nat = prev_output_tokens_new
        tgt_tokens_nat = tgt_tokens_new

        return prev_output_tokens_nat, tgt_tokens_nat



@register_model_architecture("nat_at_new", "nat_at_new")
...
@register_model_architecture("nat_at_new", "nat_at_new_wmt_en_de")
