...
class CMLMATModel(CMLMNATransformerModel):
    ...
    def forward(
        ...
        # decoding
        word_ins_out, word_ins_out_at, extra, prev_output_tokens_at = self.decoder(
        ...
        return (word_ins_out_at, extra), tgt_tokens_at
    ...
    def forward(
        ...
        **unused
        ...
        if not inference:
            ...
            if normalize:
                return F.log_softmax(decoder_out_at, -1), F.log_softmax(decoder_out_at, -1), extra, prev_output_tokens
            else:
                return decoder_out_at, decoder_out_at, extra, prev_output_tokens
...
@register_model_architecture("cmlm_at_only", "cmlm_at_only")
...
@register_model_architecture("cmlm_at_only", "cmlm_at_only_wmt_en_de")
