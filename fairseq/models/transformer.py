    ...
    def add_args(parser):
        ...
        parser.add_argument('--share-all-embeddings', action='store_true',
                            help='share encoder, decoder and output embeddings'
                                 ' (requires shared dictionary and embed dim)', default=False)
        ...
        parser.add_argument('--skip-fc1', default=False, action='store_true',
                            help='skip fc1')
        parser.add_argument('--skip-fc2', default=False, action='store_true',
                            help='skip fc2')
        # fmt: on
...
class TransformerEncoder(FairseqEncoder):
    ...
    def reorder_encoder_out(self, encoder_out: EncoderOut, new_order):
        ...
        new_encoder_out["bottom_features"] = (
            encoder_out.bottom_features
            if encoder_out.bottom_features is None
...
@register_model_architecture('transformer', 'transformer_prenorm_wmt_en_de')
