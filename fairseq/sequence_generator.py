...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            lprobs, avg_attn_scores, encoder_outs = self.model.forward_decoder(
...
class EnsembleModel(nn.Module):
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            # decode each model
            #try:
            #    model.decoder = model.decoder.top_at
            #except:
            #    pass
            if self.has_incremental_states():
            ...
            if isinstance(decoder_out[1], EncoderOut):
                encoder_out = decoder_out[1]
                decoder_out = decoder_out[0]
                encoder_outs[i] = encoder_out
            ...
            if self.models_size == 1:
                return probs, attn, encoder_outs
        ...
        return avg_probs, avg_attn, encoder_outs
