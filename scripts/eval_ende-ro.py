...
# inference
command = 'python generate.py ~/data-bin/master/wmt16.en-de.dist.reorder/ --path {}/checkpoint_top5_average.pt --task translation --max-sentences 10 --beam 5 --gen-subset test --remove-bpe  --lenpen 1.0 > {}/ende.out'.format(model_dir, model_dir)
